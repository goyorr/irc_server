...
// std::vector<std::pair<std::string, std::string> > invite_parse(std::string buffer){   // INVITE   #ch1  

//     std::vector<std::pair<std::string, std::string> > invitations;
...
//     if (is_end(buffer, &i))
//     {
//         invitations.push_back(std::make_pair("", ""));
//         return invitations;
//     }
//     size_t pos = i;
//     while (!is_ws(buffer[i]))
...
//         return invitations;
//     }
//     std::string users = buffer.substr(pos, i - pos);
//     w
//     for (pos = 0; pos < users.size(); pos++)
//     {
//         size_t j = users.find(',' , pos);
//         if (j == std::string::npos)
//         {
//             invited.push_back(users.substr(pos, users.size() - pos));
//             break;
//         }
//         invited.push_back(users.substr(pos, j - pos));
//         pos = j;
//     }
